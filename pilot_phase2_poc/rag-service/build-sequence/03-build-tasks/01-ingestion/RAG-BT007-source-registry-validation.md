...
| Worktree Path | `C:\Users\prasa\Documents\Github\waypoint-pilot-worktrees\rag-bt007-source-registry-validation` |
...
uv run pytest "app/stages/stage_01_ingestion/tests/test_source_registry.py" -q
uv run pytest -q
```
