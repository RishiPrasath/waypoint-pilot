...
| Status | Planned |
| Evidence | `build-evidence/RAG-BT013-semantic-retrieval-baseline.md` |
...
uv run python -m pytest "app/stages/stage_03_retrieval/tests/test_semantic_retrieval.py" -q
