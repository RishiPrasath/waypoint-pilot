...
| Decision / ADR | ADR-RAG-0004, RAG-DT013 |
...
| Status | Planned |
| Evidence | `build-evidence/RAG-BT017-output-validation-retry-fallback.md` |
...
uv run python -m pytest "app/stages/stage_04_generation/tests/test_output_validation.py" -q
