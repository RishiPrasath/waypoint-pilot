...
No new automated tests. This is a human verification pass after automated tests are green.

## Code To Implement

No code. Fix only if manual requests reveal drift from the agreed spec.
...
- [ ] Results are ready to compare with FastAPI later.
