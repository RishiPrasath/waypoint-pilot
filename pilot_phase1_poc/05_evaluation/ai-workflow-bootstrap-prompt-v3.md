...
| Initiative | Status | Path |
|------------|--------|------|
| enhancement--poc-evaluation | 🔄 In Progress (25/43 -- 58%) | ./ai-workflow/enhancement--poc-evaluation/ |
...
1. Read plan: `./ai-workflow/enhancement--poc-evaluation/01-plan/DETAILED_PLAN.md`
2. Check roadmap: `./ai-workflow/enhancement--poc-evaluation/02-roadmap/IMPLEMENTATION_ROADMAP.md`
